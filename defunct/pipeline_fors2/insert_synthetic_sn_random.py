...
def main(obj, test, n, filter_dist, sn_type, instrument, limit):
    ...
    for i in range(n):
        ...
        ph.insert_synthetic(x=x, y=y, obj=properties, test_path=test_path, filters=filters,
...
if __name__ == '__main__':
    ...
    main(obj=args.op, test=args.test, n=args.n, filter_dist=args.filter_dist, sn_type=args.sn_type, limit=args.limit)
