...
def pypeit_setup(root: str, output_path: str, spectrograph: str, cfg_split: str = None):
    ...
    u.system_command_verbose(system_str)
...
def pypeit_sensfunc(
    ...
    u.system_command_verbose(system_str, go_to_working_directory=run_dir)


def pypeit_flux_setup(sci_path: str, run_dir: str = None):
    u.system_command_verbose(
        f"pypeit_flux_setup {sci_path}",
        go_to_working_directory=run_dir
    )
